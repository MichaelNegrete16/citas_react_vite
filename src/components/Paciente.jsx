 const Paciente = ({paciente, setPasiente, eliminarPaciente}) => {
  
  const {nombre,raza,propietario,email,fecha,sintomas,id} = paciente

  const handleEliminar = () =>{
    console.log('Eliminando..')
    const respuesta = confirm('Desdeas eliminar este paciente ?')
    if(respuesta){
      eliminarPaciente(id)
    }
  }
